...
const projects: Project[] = [
  {
    ...
    story:
      "私はハンドメイドが趣味で、作った作品をネットで販売しています。\nそんな中で、収支を正確に把握するために、毎回手動で送料・資材費・利益の計算を行う必要がある「ムダ」に気がつきました。この課題に対して、商品情報の自動取得・コスト管理・月次レポート機能を備えたiOSアプリを開発しました。実際にアプリを日常で利用しながら改善を重ね、繰り返し発生する計算作業を効率化しました。",
